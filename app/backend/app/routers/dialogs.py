...
TOOL_PROMPT_FRAGMENTS: dict[str, str] = {
    "search_base": (
        ...
        "заново, кнопка не появится. Поэтому если просят ссылку/открыть уже "
        "упомянутую ранее заметку — вызови get_note(item_id=...) ещё раз в "
        "этом ходу, даже если тебе она и так известна."
    ),
    "run_python": (
