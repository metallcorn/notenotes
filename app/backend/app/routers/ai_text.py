...
_PROMPTS: dict[str, str] = {
    ...
    "reformat": (
        ...
        "таблицы где уместно. Содержание и факты сохраняются полностью, меняется только подача — "
        "ничего не добавляй и не убирай по смыслу. Ответь ТОЛЬКО результатом, без вступлений и "
